...
namespace GenerateNorthwindDBContext
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<decimal>> GetTotalIncome(string supplier, Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("GetTotalIncome", supplierParameter, startDateParameter, endDateParameter);
        }
        ...
        public virtual ObjectResult<Nullable<decimal>> usp_GetTotalIncome(string supplier, Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate)
        {
            var supplierParameter = supplier != null ?
                new ObjectParameter("supplier", supplier) :
                new ObjectParameter("supplier", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("usp_GetTotalIncome", supplierParameter, startDateParameter, endDateParameter);
        }
    }
}
