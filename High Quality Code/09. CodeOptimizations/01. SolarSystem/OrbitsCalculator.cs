...
namespace SolarSystem
{
    class OrbitsCalculator : INotifyPropertyChanged
    {
        ...
        // The incremental step of 0.00005 is too small for smooth operation
        // since the loops executes too many times with Decimal operations.
        private void EarthRotation()
        {
			for (decimal step = 0; step <= 360; step += 1)
			{
