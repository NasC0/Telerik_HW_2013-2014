...
// Sprites taken from google images                                                     //
//////////////////////////////////////////////////////////////////////////////////////////
...
window.onload = function() {
    ...
    function updateColor(rgbColors) {
        ...
        rgbColors[colorToIncrement] += colorIncrementSize;
    ...
    function initSnake(startingPositionX, startingPositionY) {
        ...
        for (var i = 0; i < SNAKE_START_ELEMENTS; i++) {
            ...
            if (snake.body[snake.body.length - 1] === undefined) {
                ...
                currentElementXPosition = startingPositionX + ((OBJECTS_SIZE * 2) * i);
            }
    ...
    function executeDirectionChange() {
        if (directionChangeQueue.length > 0) {
            movementVector = directionChangeQueue.pop();
        }
    }
    ...
    function gameLoop() {
        ...
        continueLoop = determineBoundaryCollision(snake);
        if (!continueLoop) {
